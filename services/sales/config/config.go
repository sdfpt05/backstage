...
func Load() (*Config, error) {
	// Server
	port, _ := strconv.Atoi(getEnv("PORT", "8093"))
	...
	return &Config{
		...
		ServiceBus: ServiceBusConfig{
			...
			QueueName:        getEnv("SERVICEBUS_QUEUE_NAME", "sales-queue"),
		},
		NewRelic: NewRelicConfig{
			AppName:    getEnv("NEW_RELIC_APP_NAME", "Sales Aggregator"),
		...
		Elasticsearch: ElasticsearchConfig{
			...
			Index:    getEnv("ES_INDEX", "sales-index"),
		},
	}, nil
}
