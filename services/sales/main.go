...
import (
	...
	"example.com/backstage/services/sales/api"
	...
	"example.com/backstage/services/sales/internal/telemetry"
...
func main() {
	...
	sbClient, err := messaging.NewServiceBusClient(cfg.ServiceBus, "sales-consumer")
	if err != nil {
